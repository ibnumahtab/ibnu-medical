                ...
                <div>
                    <div className='grid grid-cols-4 gap-x-4 text-white'>
                        <div className='p-6 rounded bg-secondary'>
                            ...
                            <p className="text-sm py-2 border-b border-gray-200">Mon – Wed - 9:00 AM – 7:00 PM </p>
                            <p className="text-sm py-2 border-b border-gray-200">Thursday - 9:00 AM – 6:30 PM</p>
                            <p className="text-sm py-2 border-b border-gray-200">Friday - 9:00 AM – 6:00 PM </p>
                            <p className="text-sm py-2 border-b border-gray-200">Sun – Sun - CLOSED</p>
                        </div>
                        <div className='p-6 rounded bg-secondary'>
                        ...
                        <div className='p-6 rounded bg-secondary'>
                            ...
                            <h2 className="mb-4 text-xl font-bold">{phoneIcon} 1-800-123-4560</h2>
                            <p className="text-sm">
                                An magnis nulla dolor at sapien augue erat
